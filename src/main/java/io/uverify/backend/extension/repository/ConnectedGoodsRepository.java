...
public interface ConnectedGoodsRepository extends JpaRepository<ConnectedGoodEntity, String> {

    @Modifying
    @Query("DELETE FROM ConnectedGoodEntity WHERE creationSlot > :target")
