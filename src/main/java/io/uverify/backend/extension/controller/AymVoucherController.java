...
import io.uverify.backend.extension.service.AymVoucherService;
...
@Slf4j
@RestController
@RequestMapping("/api/v1/extension/aym-vision/voucher")
@ConditionalOnProperty(value = "extensions.aym-vision.enabled", havingValue = "true")
public class AymVoucherController {
    ...
    private final AymVoucherService voucherService;
    private final ObjectMapper objectMapper;

    public AymVoucherController(AymHandshakeService handshakeService,
                             AymVoucherService voucherService,
    ...
    public ResponseEntity<?> create(HttpServletRequest request) {
        try {
            ...
            List<AymVoucherEntity> vouchers = voucherService.create(contentId, count, note);
