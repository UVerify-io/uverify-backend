...
public class UVerifyWitnessStorage extends TransactionWitnessStorageImpl {
    public UVerifyWitnessStorage(TxnWitnessRepository txnWitnessRepository, TxnMapper mapper, DSLContext dsl) {
        super(txnWitnessRepository, mapper, dsl);
    }
